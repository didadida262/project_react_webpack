...
export function SelectorCommon(props: ISelectorProps) {
  ...
  return (
    ...
    >
      ...
      <ul
        className={cn(
          'absolute top-[40px] max-h-[144px] w-full flex-col overflow-y-auto rounded-[4px] border-[1px] border-solid border-borderFirstColor bg-bgUlColor duration-300',
          'chain-select',
          show
        ...
        {options.map((item: ISelectorItemProps) => {
          return (
            <li
              ...
              className={cn(
                `flex h-[36px] cursor-pointer items-center gap-x-[6px] overflow-y-auto pl-4 text-textFifthSize hover:bg-bgLinkHoverColor`,
